...
if(scroll >= 12000 && scroll <= 14000){
 ...
 function animateCountryNamesOut (scroll, start, end){
   ...
   germany.style.marginTop = map(currentPos, 0, range, -100, 0) + 'vh'
   france.style.marginTop = map(currentPos, 0, range, -100, 0) + 'vh'
   spain.style.marginTop = map(currentPos, 0, range, -100, 0) + 'vh'
 }
